...
{% note warn no-icon %}
从本部分开始，考虑到已经基本讲解完成汉字读音的确定法则，除非必要，将不再提供振假名。
{% endnote %}
...
例如，上一节的练习题中的词汇表中有一个词语「付き合いたい」。其构成就是动词「付き合う」首先活用为第一连体形「付き合い」后接续表达愿望的助动词「たい」。原型「付き合う」的含义为“交往”，那么接续助动词「たい」后，就表达“想交往”的含义。
