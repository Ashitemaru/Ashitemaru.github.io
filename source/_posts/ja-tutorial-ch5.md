...
副助词，顾名思义，是一类用来辅助表达含义的助词。一般而言，副助词除了单独使用，还经常和其他助词联合使用表达更加丰富的含义。并且，副助词作为准体助词的用法更为普遍。在部分语法观点中，副助词仅有准体助词的用法，而「は」等无准体助词用法的助词则被归类为**系助词**（大部分承认系助词分类的语法观点中，系助词一般而言指的是「は、も、しか、こそ、さえ、すら」）。
