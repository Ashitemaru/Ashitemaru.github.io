...
副助词，顾名思义，是一类用来辅助表达含义的助词。一般而言，副助词除了单独使用，还经常和其他助词联合使用表达更加丰富的含义。

这里首先需要说明格助词和副助词连用的特例。副助词是可以接在格助词之后的，然而格助词「が①」和「を」是特殊的，当它们和副助词连用的使用，一般会省略掉格助词。不过，作为特例，有时也会出现类似「をも」等少量不省略的用法。例如：

- 誰**か**来たらしい。（好像有谁来了）

这里「か」是表示不定语义的副助词，「誰」在这句话里事实上是主语成分，然而格助词「が」在和副助词「か」连用的时候省略了。

再进一步，副助词事实上也有准体助词的概念：

- 誰**か**が来たらしい。（好像有谁来了）

这里副助词「か」事实上和「誰」共同构成了类似体言的成分，由格助词「が」统领作为句子的主语。

所以可以看到，这两句话虽然很相似，却有着不同的语法底层。不过，如果从作者语感的角度出发的话「誰かが」是更常见、更自然的用法。

## 不定语义「か②」

该副助词用于表达不确定的语义。常见用法是将其接续在疑问词之后，如「誰**か**、何**か**、どこ**か**、いくつ**か**」等表达：

- どこから**か**きれいな音楽が聞こえてきた。（不知哪里传来悦耳的音乐）
- 箱には何**か**がある。（箱子里应该有点什么）

{% note info no-icon %}
「か」和格助词连用时的助词顺序似乎很多时候依靠语感。就作者的经验，「か」大部分情况下位于格助词之后，例如「とか、からか」等。然而和格助词「が」连用的时候则更多见的是准体助词用法的「かが」。
{% endnote %}