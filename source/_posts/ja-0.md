...
| 助動詞 | だ | × | で／だっ／（に） | （な） | なら | × | だろ |
| 助動詞 | ようだ | × | ようで／ようだっ／ように | ような | ようなら | × | ようだろ |
| 助動詞 | そうだ「様態」 | × | そうで／そうだっ／そうに | そうな | そうなら | × | そうだろ |

「べし」的活用类似于古语形容词。

| 類型 | 終止形 | 未然形 | 連用形 | 連体形 | 仮定形 | 命令形 | 意志形 |
| :-: | :-: | :-: | :-: | :-: | :-: | :-: | :-: |
| 文語形容詞 | 高き | 高から | 高く | 高き | 高けれ | × | × |
...
助词和助动词的差别在于，助词一般不具有活用。日语中的助词相当庞杂，含义也各异，和用言的接续方式更是杂乱。

助词可以粗略分为格助词、终助词、副助词、接续助词四类，下面按照这个顺序简单介绍日语助词，具体的使用和例句则在之后介绍。
